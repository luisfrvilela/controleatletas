...
public class CadastroJogadorDeBasquete1 extends javax.swing.JFrame {
    ...
    private ControleJogadorDeBasquete controleBoxeador;
    ...
    public CadastroJogadorDeBasquete1() {
        initComponents();
        this.habilitarDesabilitarCampos();
        this.controleBoxeador = new ControleJogadorDeBasquete();
    ...
    private void preencherCampos() {
        ...
        jTextFieldAltura.setText(Double.toString(umJogadorDeBasquete.getAltura()));
        jTextFieldBairro.setText(umJogadorDeBasquete.getEndereco().getBairro());
        jTextFieldCategoriaPeso.setText(Double.toString(umJogadorDeBasquete.getPeso()));
        jTextFieldCep.setText(umJogadorDeBasquete.getEndereco().getCep());
        jTextFieldCidade.setText(umJogadorDeBasquete.getEndereco().getCidade());
        jTextFieldComplemento.setText(umJogadorDeBasquete.getEndereco().getComplemento());
        jTextFieldCpf.setText(umJogadorDeBasquete.getCpf());
        if (umJogadorDeBasquete.getDataNascimento() == null) {
            jTextFieldDataNascimento.setText(null);
        } else {
            jTextFieldDataNascimento.setText(dateFormat.format(umJogadorDeBasquete.getDataNascimento()));
        }
        jTextFieldEnvergadura.setText(Double.toString(umJogadorDeBasquete.getEnvergadura()));
        jComboBoxEstado.setSelectedItem(umJogadorDeBasquete.getEndereco().getEstado());
        jTextFieldLogradouro.setText(umJogadorDeBasquete.getEndereco().getLogradouro());
        jTextFieldNome.setText(umJogadorDeBasquete.getNome());
        jTextFieldNomeMae.setText(umJogadorDeBasquete.getNomeMae());
        jTextFieldNomePai.setText(umJogadorDeBasquete.getNomePai());
        jTextFieldNumero.setText(umJogadorDeBasquete.getEndereco().getNumero().toString());
        jTextFieldPais.setText(umJogadorDeBasquete.getEndereco().getPais());
        jTextFieldPeso.setText(Double.toString(umJogadorDeBasquete.getPeso()));
        jTextFieldRg.setText(umJogadorDeBasquete.getRg());
        jTextFieldTotalDerrotas.setText(Integer.toString(umJogadorDeBasquete.getTotalDerrotas()));
        jTextFieldTotalDesistencias.setText(Integer.toString(umJogadorDeBasquete.getTotalDesistencias()));
        jTextFieldTotalEmpates.setText(Integer.toString(umJogadorDeBasquete.getTotalEmpates()));
        jTextFieldTotalLutas.setText(Integer.toString(umJogadorDeBasquete.getNumeroDaCamisa()));
        jTextFieldTotalNocaute.setText(Integer.toString(umJogadorDeBasquete.getTotalVitoriasNocaute()));
        jTextFieldTotalVitorias.setText(Integer.toString(umJogadorDeBasquete.getTotalVitorias()));
        ...
        switch (umJogadorDeBasquete.getSexo()) {
        ...
        switch (umJogadorDeBasquete.getApelido()) {
        ...
        switch (umJogadorDeBasquete.getEstilo()) {
    ...
    private void salvarRegistro() {
        ...
        if (novoRegistro == true) {
            umJogadorDeBasquete = new JogadorDeBasquete(jTextFieldNome.getText());
        } else {
            umJogadorDeBasquete.setNome(jTextFieldNome.getText());
        }
        ...
        umJogadorDeBasquete.setAltura(Double.parseDouble(jTextFieldAltura.getText()));
        umJogadorDeBasquete.setNomeMae(jTextFieldNomeMae.getText());
        umJogadorDeBasquete.setNomePai(jTextFieldNomePai.getText());
        umJogadorDeBasquete.setPeso(Double.parseDouble(jTextFieldPeso.getText()));
        umJogadorDeBasquete.setCpf(jTextFieldCpf.getText());
        umJogadorDeBasquete.setRg(jTextFieldRg.getText());
        umJogadorDeBasquete.setEnvergadura(Double.parseDouble(jTextFieldEnvergadura.getText()));
        umJogadorDeBasquete.setTotalDerrotas(Integer.parseInt(jTextFieldTotalDerrotas.getText()));
        umJogadorDeBasquete.setTotalDesistencias(Integer.parseInt(jTextFieldTotalDesistencias.getText()));
        umJogadorDeBasquete.setTotalEmpates(Integer.parseInt(jTextFieldTotalEmpates.getText()));
        umJogadorDeBasquete.setNumeroDaCamisa(Integer.parseInt(jTextFieldTotalLutas.getText()));
        umJogadorDeBasquete.setTotalVitoriasNocaute(Integer.parseInt(jTextFieldTotalNocaute.getText()));
        umJogadorDeBasquete.setTotalVitorias(Integer.parseInt(jTextFieldTotalVitorias.getText()));

        switch (jComboBoxSexo.getSelectedIndex()) {
            case SEXO_MASCULINO_INDICE:
                umJogadorDeBasquete.setSexo(SEXO_MASCULINO_VALOR);
                break;
            case SEXO_FEMININO_INDICE:
                umJogadorDeBasquete.setSexo(SEXO_FEMININO_VALOR);
                break;
        }

        switch (jComboBoxCategoria.getSelectedIndex()) {
            case CATEGORIA_AMADOR_INDICE:
                umJogadorDeBasquete.setApelido(CATEGORIA_AMADOR_VALOR);
                break;
            case CATEGORIA_PROFISSIONAL_INDICE:
                umJogadorDeBasquete.setApelido(CATEGORIA_PROFISSIONAL_VALOR);
                break;
        }

        switch (jComboBoxEstilo.getSelectedIndex()) {
            case ESTILO_ORTODOXO_INDICE:
                umJogadorDeBasquete.setEstilo(ESTILO_ORTODOXO_VALOR);
                break;
            case ESTILO_SOUTHPAW_INDICE:
                umJogadorDeBasquete.setEstilo(ESTILO_SOUTHPAW_VALOR);
                break;
        }

        if (novoRegistro == true) {
            controleBoxeador.adicionar(umJogadorDeBasquete);
        }
        modoAlteracao = false;
        novoRegistro = false;
    ...
    private void carregarListaBoxeadores() {
        ArrayList<JogadorDeBasquete> listaBoxeadores = controleBoxeador.getListaBoxeadores();
        DefaultTableModel model = (DefaultTableModel) jTableListaBoxeadores.getModel();
        model.setRowCount(0);
        for (JogadorDeBasquete b : listaBoxeadores) {
    ...
    private void atualizarCategoriaPeso() {
        ...
        jTextFieldCategoriaPeso.setText(JogadorDeBasquete.obterCategoriaPesoNome(categoria, Double.parseDouble(jTextFieldPeso.getText())));
    }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        this.controleBoxeador.remover(umJogadorDeBasquete);
        umJogadorDeBasquete = null;
        this.limparCampos();
        this.carregarListaBoxeadores();
        this.habilitarDesabilitarCampos();
...
private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
    ...
    private void pesquisarBoxeador(String nome) {
        JogadorDeBasquete boxeadorPesquisado = controleBoxeador.pesquisar(nome);

        if (boxeadorPesquisado == null) {
            exibirInformacao("Boxeador não encontrado.");
        } else {
            this.umJogadorDeBasquete = boxeadorPesquisado;
            this.preencherCampos();
            this.habilitarDesabilitarCampos();
        }
    }
